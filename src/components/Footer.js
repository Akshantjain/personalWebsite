    ...
    return (
        <section id="contact" className="bg-gray-100 py-2 space-y-5">
            <div className="container mx-auto w-full divide-y divide-gray-300">
                ...
                <div className="container mx-auto py-5 flex">
                    <div className="mr-auto self-center px-3 font-caveat text-gray-900 dark:text-white text-4xl rounded-2xl">AJ</div>
                    <p className="font-caveat px-3 text-4xl text-gray-900 dark:text-white drop-shadow-2xl subpixel-antialiased font-normal tracking-normal leading-tight">Akshant Jain</p>
                </div>
            </div>
        </section>
    )

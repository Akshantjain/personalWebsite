...
export const Coursework = ({data}) => {
    return (
        <section id="coursework" className="mt-2 py-2 pb-20 space-y-10">
            <div className="container mx-auto rounded-2xl bg-gray-100 shadow-2xl
                ...
                <div className="container mx-auto rounded-2xl py-7 bg-yellow-500 shadow-2xl
                    ...
                    <div className="scale-95 container transform origin-center -rotate-2 
                        ...
                        <div className="text-4xl flex font-bold rounded-t-2xl p-10 bg-yellow-200 shadow z-50  text-yellow-900">
                            <p className="ml-auto">Coursework & Skills</p>
                            <BookOpenIcon className="h-10 w-auto mb-1 ml-4" />
                        </div>
                        <div className="grid grid-cols-3">
                            <div className="py-5 px-10 leading-10 col-span-1 text-right text-2xl font-semibold text-yellow-900
                            ...
                            <div className="container py-5 px-10 text-xl leading-10 col-span-2 border-b-2 border-yellow-100">
                                {data.languages.map((val, key) => {
                                    return <>{val}{key !== data.languages.length-1 ? ',' : ''} </>;
                                })}
                            </div>
                            <div className="py-5 px-10 leading-10 col-span-1 text-right text-2xl font-semibold text-yellow-900

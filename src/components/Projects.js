                ...
                <div className="container mx-auto rounded-2xl py-7 bg-red-500 shadow-2xl
                    ...
                    <div className="scale-95 container transform origin-center rotate-0 md:-rotate-2 
                        ...
                        <div className="grid grid-rows-1">
                            {project.map((value, key) => {
                                return <div key={key} className="grid grid-cols-1 lg:grid-cols-3">
                                    <div className="py-5 px-10 leading-10 col-span-1 text-left lg:text-right text-lg font-bold text-red-900 bg-red-50 border-b-2 border-red-100 grid grid-rows-2">
                                            ...
                                            <div className="my-auto divide-x-2 divide-red-50 lg:mt-auto lg:my-0">
                                                <a
                                                    href={value.repo_url}
                                                    ...
                                                    className={classNames(
                                                        " rounded-l-md p-2 px-4 font-bold transition-all duration-500 ease-in-out",
                                                        { "bg-red-200 hover:bg-red-700 hover:opacity-90 hover:text-red-50": value.repo_url !== undefined },
                                                        { "bg-red-100": value.repo_url === undefined }
                                                    )}
                                                >
                                                    CODE
                                                </a>
                                                <a 
                                                    ...
                                                    target="_blank"
                                                    className={classNames(
                                                        "rounded-r-md p-2 px-4 font-bold transition-all duration-500 ease-in-out",
                                                        { "bg-red-200 hover:bg-red-700 hover:opacity-90 hover:text-red-50": value.website_url !== undefined},
                                                        {"bg-red-100 text-red-50" : value.website_url === undefined}
                                                        )}
                                                >
                                                        DEMO
                                                </a>
                                    ...
                                    <div className="container py-5 px-10 text-xl leading-10 col-span-2 divide-y-2 divide-solid divide-gray-100 border-b-2 border-red-100">
                            ...
                            <a target="_blank" rel="noopener noreferrer" href={data.links.github}><div className="transition-all duration-300 ease-linear bg-red-50 rounded-b-2xl font-head text-3xl py-6 text-center text-red-900 font-semibold hover:bg-red-200">
                                More Projects
                            </div></a>
                        </div>
                    </div>

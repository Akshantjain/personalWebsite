...
export const Projects = ({data}) => {
    ...
    return (
        <section id="projects" className="js-show-on-scroll mt-2 pb-3 md:pb-10 lg:pb-20 space-y-10" data-show="right">
                ...
                <div className="container mx-auto rounded-2xl py-7 bg-red-500 shadow-2xl
                    ...
                    <div className="scale-95 container transform origin-center rotate-0 md:-rotate-2 
                        ...
                        <div className="font-sans text-4xl flex flex-row-reverse lg:flex-row font-bold rounded-t-2xl p-10 bg-red-200 shadow z-50 text-red-900">
                            <a target="_blank" rel="noopener noreferrer" aria-label="Projects" tabIndex="-1" href={data.links.github} className="transition-all ease-in-out duration-500 hover:text-black fab fa-github">{' '}</a>
                            <p className="mr-auto lg:mr-0 ml-4 lg:ml-auto js-show-on-scroll" data-show="left">Projects</p>
                        ...
                        <div className="grid grid-rows-1">
                            {project.map((value, key) => {
                                return <div key={key} className="grid grid-cols-1 lg:grid-cols-3">
                                    <div className="py-5 px-10 leading-10 col-span-1 text-left lg:text-right text-lg font-bold text-red-900 bg-red-50 border-b-2 border-red-100 grid grid-rows-2">
                                        <div className="js-show-on-scroll" data-show="left">
                                            <p className="font-proHead text-2xl underline">{value.heading}</p>
                                            <p className="font-head text-xl text-red-700">{value.timeFrame}</p>
                                        </div>
                                        <div className="relative inline-flex ml-0 lg:ml-auto my-auto divide-x-2 divide-red-50 lg:mt-auto lg:my-0 js-show-on-scroll" data-show="left">
                                                <a
                                                    href={value.repo_url}
                                                    ...
                                                    className={classNames(
                                                        ...
                                                        { "bg-red-50 opacity-75 cursor-not-allowed pointer-events-none": value.repo_url === undefined }
                                                    )}
                                                >
                                                ...
                                                <a 
                                                    ...
                                                    className={classNames(
                                                        ...
                                                        { "bg-red-50 opacity-75 cursor-not-allowed pointer-events-none" : value.website_url === undefined}
                                                        )}
                                                >
                                    ...
                                    <div className="container py-5 px-10 text-xl leading-10 col-span-2 border-b-2 border-red-100 js-show-on-scroll" data-show="right">
                                        <span className="font-semibold">Description:</span>
                                        <ul className="list-outside list-disc border-gray-100">
                            ...
                            <a target="_blank" rel="noopener noreferrer" href={data.links.github}>
                                <div className="flex justify-start items-center w-100 transition-all duration-300 ease-linear bg-red-100 rounded-b-2xl font-head text-3xl py-6 text-center text-red-900 font-semibold hover:bg-red-300">
                                    ...
                                    <span className="mr-auto js-show-on-scroll" data-show="right">More Projects</span>
                                </div>
                            </a>
                        </div>
                    </div>

        ...
        <Fragment>
            <nav id="navbar" className="bg-gray-100 bg-opacity-25 fixed w-full shadow z-50 transition-colors duration-300 ease-linear">
                <div className="container mx-auto flex-none lg:flex flex-row full-width transition ease-linear duration-900 transform scale-90 py-3 px-3">
                    ...
                    <div className={classNames('z-0 flex-none space-y-5 lg:space-y-0 lg:flex lg:flex-row space-x-0 lg:space-x-6 py-3 justify-end text-base font-sans font-semibold antialiased text-gray-700 transition-all duration-700 ease-in-out', { '-mt-68 invisible': !show }, 'lg:mt-0  lg:visible')}>

    ...
    return (aboutMe && 
            <header className="font-sans mx-auto grid grid-cols-3 dark:bg-gray-800 gap-4 h-screen pt-5 min-h-60 place-items-center">
                <div className="mt-32 ml-5">
                        ...
                        <p className="font-caveat text-7xl underline text-black dark:text-white drop-shadow-2xl subpixel-antialiased font-extrabold tracking-normal leading-tight">{aboutMe.name}</p>
                ...
                <div className="bg-gradient-to-b from-blue-300 to-blue-800 bg-opacity-50
                    ...
                    <img src={myImage} alt="Me" id="myImage" 
                        className="scale-99 opacity-95 transition-transform ease-in delay-300 duration-700 
